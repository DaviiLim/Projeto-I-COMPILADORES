...
public interface NemesisListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link NemesisParser#cmdIf}.
	 * @param ctx the parse tree
	 */
	void enterCmdIf(NemesisParser.CmdIfContext ctx);
	/**
	 * Exit a parse tree produced by {@link NemesisParser#cmdIf}.
	 * @param ctx the parse tree
	 */
	void exitCmdIf(NemesisParser.CmdIfContext ctx);
	/**
	 * Enter a parse tree produced by {@link NemesisParser#cmdWhile}.
	 * @param ctx the parse tree
	 */
	void enterCmdWhile(NemesisParser.CmdWhileContext ctx);
	/**
	 * Exit a parse tree produced by {@link NemesisParser#cmdWhile}.
	 * @param ctx the parse tree
	 */
	void exitCmdWhile(NemesisParser.CmdWhileContext ctx);
	/**
